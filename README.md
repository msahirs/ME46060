...
| 5 | Investigate the influence of the step size on the accuracy of finite difference gradients. Understand the KKT conditions for constrained optimization. | Not started |
